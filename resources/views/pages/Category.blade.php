<x-layout title="Category | Jelajah Nusantara">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="http://localhost/laravel_katalogue/public/category/add-category" method="POST">
              @csrf
                <div class="mb-3">
    ...
    <div class="mt-5 ms-5 col-md-12 ">
        ...
        <form action="http://localhost/laravel_katalogue/public/category" method="GET" class="col-md-9 mt-3">
            ...
            <tbody>  
              ...
              $counter = ($category->currentPage() - 1) * $category->perPage() + 1;
               ...
               <tr>
                ...
                <td>{{$item->category}}</td>
                <td>
                <a href="http://localhost/laravel_katalogue/public/category/edit/{{$item->id}}" class="me-1 fas fa-pen text-primary text-decoration-none"></a>
                <a href="http://localhost/laravel_katalogue/public/category/delete/{{$item->id}}" class="ms-1 fas fa-trash text-danger"></a>  
                <td>
              </tr>
              @endforeach
            </tbody>
